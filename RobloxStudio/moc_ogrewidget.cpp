...
const QMetaObjectExtraData QOgreWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QOgreWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QOgreWidget,
      qt_meta_data_QOgreWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QOgreWidget::getStaticMetaObject() { return staticMetaObject; }
